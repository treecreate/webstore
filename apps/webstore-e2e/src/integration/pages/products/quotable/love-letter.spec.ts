...
describe('BabySignProductPage', () => {
  ...
  describe('Baby sign product page', () => {
    ...
    it('goes to the right frame when pressing prev', () => {
      ...
      cy.get('[data-cy=prev-design-button]').click({ force: true });
      cy.get('[data-cy=design]').should('contain', 'assets/quotable/frame-design/love-letter/frame17.svg');

      cy.get('[data-cy=prev-design-button]').click({ force: true });
      cy.get('[data-cy=design]').should('contain', 'assets/quotable/frame-design/love-letter/frame16.svg');
    });
    ...
    it('goes to the right frame when pressing next', () => {
      ...
      cy.get('[data-cy=design]').should('contain', 'assets/quotable/frame-design/love-letter/frame14.svg');

      cy.get('[data-cy=next-design-button]').click({ force: true });
      cy.get('[data-cy=design]').should('contain', 'assets/quotable/frame-design/love-letter/frame15.svg');
