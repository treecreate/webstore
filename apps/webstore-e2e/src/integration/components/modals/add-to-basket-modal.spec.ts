...
describe('AddToBasketModal', () => {
  ...
  it('should increase / decrease dimensions', () => {
    ...
    cy.get('[data-cy=add-to-basket-dimension]').should('contain', '20x20cm');
    ...
    cy.get('[data-cy=add-to-basket-dimension]').should('contain', '25x25cm');
    cy.get('[data-cy=add-to-basket-increase-dimension-button]').click();
    cy.get('[data-cy=add-to-basket-dimension]').should('contain', '30x30cm');
