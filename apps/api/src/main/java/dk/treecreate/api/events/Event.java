...
public class Event
{
    ...
    @ApiModelProperty(notes = "UUID of the event entity",
    ...
    @ApiModelProperty(
        notes = "Id of the events's user. Doesn't correspond to database user if it was made when not logged in",
        example = "c0a80121-7ac0-190b-817a-c08ab0a12345")
    private UUID userId;
    ...
    @Override public boolean equals(Object o)
    {
        ...
        Event event = (Event) o;
        return eventId.equals(event.eventId) && name.equals(event.name) &&
