...
public class Dfm {
     ...
     */
    public Dfm() { /* Blank class constructor */ }

    /**
     * Class constructor with all possible values
     * @param insurance_type Type of insurance to be booked. <p> 
     * Allowed values: ["A", "B", "C", "D"]
     * @param insurance_amount Amount in DKK that should be insured for the shipment.
     * @param dot_type Type of DOT used for the shipment. <p>
     * Allowed values: ["DO1", "DO2", "DO3", "DO4"]
