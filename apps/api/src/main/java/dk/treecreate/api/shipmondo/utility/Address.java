...
public class Address {
   ...
   */
  public Address(
      String address1, String address2, String zipcode, String city, String country_code) {
    this.address1 = address1;
  ...
  /**
   * Compares the passed country code with the CountryCodes enum to ensure it is valid and then sets
   * it
   *
  ...
  public void setCountry_code(String country_code) {
    try {
      ...
      throw new ResponseStatusException(
          HttpStatus.BAD_REQUEST, "Invalid country code{'" + country_code + "'} ");
    }
  }
