...
public class Customs {
   ...
   *
   * @param export_reason Reason for exporting the goods.
   *     <p>Allowed values: ["sale_of_goods", "gift", "documents", "commercial_samples",
   *     "returned_goods", "other"]
   * @param term_of_trade Incoterm for the shipments i.e. DDP when customs should be payed by the
   *     sender.
   *     <p>Example: "DAP"
   * @param currency_code Currency code for prices declared in goods
   *     <p>Example: "DKK"
   * @param goods Array of Goods objects with all required data
   */
  public Customs(
      String export_reason, String term_of_trade, String currency_code, List<Goods> goods) {
