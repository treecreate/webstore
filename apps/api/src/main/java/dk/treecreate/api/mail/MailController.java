...
public class MailController
{
  ...
  public void signup(@Parameter(name = "email", description = "An address that the email is to be sent to")
                     @RequestBody SignupDto signupDto,
                     @Parameter(name = "lang", description = "Language of the email. Defaults to danish (dk)." +
                       "\nValid values: 'en', 'dk'", example = "en")
  ...
  public void resetPassword(@Parameter(name = "email", description = "An address that the email is to be sent to")
