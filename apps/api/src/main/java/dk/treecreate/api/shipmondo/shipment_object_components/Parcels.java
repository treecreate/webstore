 ...
 *
 * <p>It is to be provided as a list with individual parcels to the ShipmentObject.
 *
 * <p>Each Parcels object is meant to represent one kind of package. Eg. one size of trees
 */
public class Parcels {
   ...
   * @param declared_value Value of the goods in the parcel. Used in terms of insurance for certain
   *     carriers.
   */
  public Parcels(
      int quantity,
      ...
      int height,
      double volume,
      double running_metre,
      String description,
      String packaging,
      List<DangerousGoods> dangerous_goods,
  ...
  /**
   * Package type for the parcel. Must be a valid package type for the customer. Valid parcels are:
   * [ TODO - FIND OUT ]
   */
