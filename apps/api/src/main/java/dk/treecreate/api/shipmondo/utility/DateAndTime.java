...
public class DateAndTime {
   ...
   *
   * @param time String representing time separated by a ':'
   *     <p>Example: "15:00"
   * @return String<Time>
  ...
  private String checkTime(String time) {
    try {
      ...
      throw new ResponseStatusException(
          HttpStatus.BAD_REQUEST, "Unable to process time {'" + time + "'} into HH:mm");
    }
  }
   ...
   *
   * @param date String representing the date separated by two '-'
   *     <p>Example: "2021-12-24"
   * @return String<Date>
  ...
  private String checkDate(String date) {
    try {
      ...
      throw new ResponseStatusException(
          HttpStatus.BAD_REQUEST, "Unable to process date {'" + date + "'} into yyyy-MM-dd");
    }
  }
  // Getters and setters
  ...
  /**
   * Sets and formats the date if it can be parsed
   *
   * <p>Throws an error if it can't
   *
   * @param date Date formatted: yyyy-mm-dd
   *     <p>Example: "2021-02-24"
   */
  ...
  /**
   * Sets the time if the time matches the format
   *
   * <p>Throws an Exception if it does not.
   *
   * @param from_time Time formatted: HH:mm
   *     <p>Example: "02:49"
   */
