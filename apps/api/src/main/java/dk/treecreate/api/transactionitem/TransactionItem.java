...
public class TransactionItem {
  ...
  @Type(type = "uuid-char")
  @ApiModelProperty(
      notes = "UUID of the transaction item entity",
  ...
  @ApiModelProperty(notes = "Id of the order", example = "c0a80121-7ac0-190b-817a-c08ab0a12345")
  ...
  public boolean equals(Object o) {
    ...
    return quantity == that.quantity
        && transactionItemId.equals(that.transactionItemId)
        && dimension == that.dimension
        && design.equals(that.design);
  }
