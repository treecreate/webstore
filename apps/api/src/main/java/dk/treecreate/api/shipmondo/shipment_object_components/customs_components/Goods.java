...
public class Goods {
   ...
   * @param commodity_code Classification numbers for goods. For more visit vita.skat.dk
   *     <p>Example: "8471000000"
   * @param unit_value Unit value in declared currency
   *     <p>Example: 50.75
   * @param unit_weight Unit weight in gram
   *     <p>Example: 100
   */
  public Goods(
      int quantity,
