...
public class CreateOrderRequest {
  ...
  @NotNull
  @ApiModelProperty(notes = "Status of the order", example = "PENDING", required = false)
  private OrderStatus status = OrderStatus.INITIAL;

  @Min(1)
  @ApiModelProperty(
      name = "How many planted trees the order has. Default is 1",
      example = "1",
      required = false)
  ...
  @ApiModelProperty(notes = "Billing information for the given order")
