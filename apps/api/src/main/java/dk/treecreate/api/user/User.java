...
public class User {
  ...
  @ApiModelProperty(
      notes = "UUID token used for things like verification",
  ...
  // for simplicity, the username is the email, and just exists as an extra field/column to satisfy
  // spring security requirements
  @NotBlank
  @Size(max = 254)
  @ApiModelProperty(
      name = "Same as the email, used for authentication",
  ...
  @Basic
  @ApiModelProperty(
      notes = "User's phoneNumber, used for shipping purposes",
      example = "+4512345678")
  @Size(max = 15)
  ...
  @Basic
  @ApiModelProperty(
      notes = "User's address, used for shipping purposes",
