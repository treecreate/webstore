...
public class PickUp extends Address {
  ...
  // Pickup instruction to the carrier. Only applicable for products which supports pickup
  // instructions.
   ...
   * @param attention
   * @param telephone
   * @param instruction Pickup instruction to the carrier. Only applicable for products which
   *     supports pickup instructions.
