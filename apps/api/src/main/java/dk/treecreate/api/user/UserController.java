...
public class UserController {
  ...
  @ApiResponses(
      value = {
        @ApiResponse(code = 200, message = "A list of users", response = GetUsersResponse.class)
      })
  ...
  @ApiResponses(
      value = {
        @ApiResponse(code = 200, message = "User information", response = User.class),
  ...
  @ApiResponses(
      value = {
        @ApiResponse(code = 204, message = "A list of users", response = GetUsersResponse.class)
      })
  @PreAuthorize("hasRole('DEVELOPER') or hasRole('ADMIN')")
  ...
  public void sendResetPasswordEmail(
    ...
    try {
      mailService.sendResetPasswordEmail(email, user.getToken(), localeService.getLocale(lang));
    } catch (Exception e) {
  ...
  public User updatePassword(
    ...
    User user =
        userRepository
            .findByToken(updatePasswordRequest.getToken())
            .orElseThrow(() -> new ResourceNotFoundException("User not found"));
