...
class MailServiceTest {
  ...
  // Potential test would be validating that sendMail() method gets called correctly but it is
  // private
    ...
    return Stream.of(
        ...
        Arguments.of(
            "thisIsExactly253Characters"
                ...
                + "Åæøæøæøæøæøæøæøæøæøæøæøæø"
                + "@domain.yahoo",
            true),
        Arguments.of(
            "thisIsExactly254Characters"
                + "AccordingToAllKnownLawsOfAviationThereIsNoWayABeeShouldBeAbleToFly"
                + "ItsWingsAreTooSmallToGetItsFatLittleBodyOffTheGroundTheBeeOfCourse"
                + "FliesAnywayBecauseBeesDontCareWhatHumansThinkIsImpossible"
                + "Åæøæøæøæøæøæøæøæøæøæøæøæøæ"
                + "@domain.yahoo",
            true),
        Arguments.of(
            "thisIsExactly255Characters"
                + "AccordingToAllKnownLawsOfAviationThereIsNoWayABeeShouldBeAbleToFly"
                + "ItsWingsAreTooSmallToGetItsFatLittleBodyOffTheGroundTheBeeOfCourse"
                + "FliesAnywayBecauseBeesDontCareWhatHumansThinkIsImpossible"
                + "Åæøæøæøæøæøæøæøæøæøæøæøæøæø"
                + "@domain.yahoo",
            true),
        Arguments.of(
            "thisIsExactly256Characters"
                + "AccordingToAllKnownLawsOfAviationThereIsNoWayABeeShouldBeAbleToFly"
                + "ItsWingsAreTooSmallToGetItsFatLittleBodyOffTheGroundTheBeeOfCourse"
                + "FliesAnywayBecauseBeesDontCareWhatHumansThinkIsImpossible"
                + "Åæøæøæøæøæøæøæøæøæøæøæøæøæøæ"
                + "@domain.yahoo",
            false));
  }
