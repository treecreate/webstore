...
class OrderServiceTest {
  ...
  private static Stream<Arguments> verifyPriceArguments() {
    return Stream.of(
        ...
        Arguments.of(
            69,
            new BigDecimal(4756239),
            new BigDecimal("1475114.09"),
            69,
            DiscountType.PERCENT,
            true,
            true,
  ...
  private static Stream<Arguments> calculateTotalArguments() {
    return Stream.of(
        Arguments.of(
            new BigDecimal(499), 100, DiscountType.AMOUNT, false, new BigDecimal("399.00"), null),
        Arguments.of(
            new BigDecimal(499), 100, DiscountType.PERCENT, false, new BigDecimal("0.00"), null),
        Arguments.of(
            new BigDecimal(499), 50, DiscountType.PERCENT, false, new BigDecimal("249.50"), null),
  ...
  private static Stream<Arguments> pricePerItemArguments() {
    return Stream.of(
        ...
        Arguments.of(
            DesignType.FAMILY_TREE, DesignDimension.ONE_SIZE, null, "dimension data is not valid"));
  }
  ...
  void calculateTotal(
    ...
    if (expectedTotal != null) {
      ...
      assertEquals(orderService.calculateTotal(subTotal, discount, hasMoreThan3), expectedTotal);
    } else {
      Throwable exception =
          assertThrows(
              ResponseStatusException.class,
